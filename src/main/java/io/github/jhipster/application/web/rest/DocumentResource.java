...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Document}.
 */
@RestController
@RequestMapping("/api")
public class DocumentResource {
    ...
    private static final String ENTITY_NAME = "jhipsterCoreApplicationDocument";
